...
import com.example.valve.Inbox_flow.I_check;
...
//                        performDefaultAction(x);
    ...
    private void viewTicket(int x){
        I_check iCheck = new I_check();
        Bundle args=new Bundle();
        args.putInt("id",x);
        iCheck.setArguments(args);


        // Start the fragment transaction
        FragmentTransaction transaction = fragmentManager.beginTransaction();
        transaction.replace(R.id.fragment_carrier_id_ap, iCheck); // Replace with the ID of your fragment container
