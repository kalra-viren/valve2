...
//import com.example.valve.Approved_flow.A_TicketApproved;
...
//                        performDefaultAction(x);
    ...
    private void performApprovedAction(int x){
        Re_TicketApproved reTicketApproved = new Re_TicketApproved();
        Bundle args=new Bundle();
        args.putInt("id",x);
        reTicketApproved.setArguments(args);


        // Start the fragment transaction
        FragmentTransaction transaction = fragmentManager.beginTransaction();
        transaction.replace(R.id.fragment_carrier_id_ap, reTicketApproved); // Replace with the ID of your fragment container
